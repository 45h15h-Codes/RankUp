...
const servicesAndSolutions: ServiceMediaItem[] = [
  {
    ...
    mediaType: 'image',
    mediaSrc: 'https://images.unsplash.com/photo-1508514177221-18d14037b732?auto=format&fit=crop&q=80&w=800',
    mediaAlt: 'Solar lead generation dashboard',
  ...
  },
  {
    ...
    mediaType: 'image',
    mediaSrc: 'https://images.unsplash.com/photo-1542332213-31f87348057f?auto=format&fit=crop&q=80&w=800',
    mediaAlt: 'Solar appointment booking automation',
  ...
  },
  {
    ...
    mediaAlt: 'Solar ad campaign walkthrough',
