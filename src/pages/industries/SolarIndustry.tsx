...
const stats = ['+240% Lead Growth', 'Rs 450 Cost Per Lead', '95% Lead Quality'];
const challenges = ['High competition', 'Long sales cycles', 'Lead qualification issues'];
const solutions = ['Targeted Meta & Google Ads', 'Custom Qualification Funnels', 'Automated CRM Nurturing'];
...
const servicesAndSolutions: ServiceMediaItem[] = [
  {
    title: 'Solar Lead Capture Funnel',
    description: 'Landing pages and instant qualification flows that capture high-intent home owners.',
    mediaType: 'image',
    mediaSrc: 'https://picsum.photos/seed/solar-service-1/960/640',
    mediaAlt: 'Solar lead funnel dashboard preview',
  },
  {
    title: 'Automated Follow-up Journeys',
    description: 'WhatsApp, email, and CRM automations to keep every inquiry engaged until site visit.',
    mediaType: 'image',
    mediaSrc: 'https://picsum.photos/seed/solar-service-2/960/640',
    mediaAlt: 'Solar CRM automation workflow',
  },
  {
    title: 'Installation Pipeline Visibility',
    description: 'Track lead-to-installation stages with real-time campaign and sales pipeline reporting.',
    mediaType: 'video',
    mediaSrc: 'https://www.w3schools.com/html/mov_bbb.mp4',
    mediaAlt: 'Solar pipeline reporting walkthrough video',
  },
];
    ...
    <div className="pt-32 pb-20">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
          <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}>
            <h1 className="text-5xl md:text-6xl font-extrabold text-heading mb-8 leading-tight">
              ...
              <span className="text-primary">Solar Industry</span>
            </h1>
            <p className="text-xl text-body mb-10 leading-relaxed">
              Accelerate your solar sales with high-intent lead generation and automated follow-ups. We understand the
              unique challenges of the Solar Industry sector and have built proven systems to overcome them.
            </p>
        ...
        <div className="bg-primary rounded-[40px] p-12 text-center text-white">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to scale your Solar Industry business?</h2>
