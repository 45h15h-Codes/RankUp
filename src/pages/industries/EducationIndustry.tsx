...
const stats = ['+120% Enrollment Rate', '-40% Acquisition Cost', '85% Lead Engagement'];
const challenges = ['Seasonal demand', 'High lead volume management', 'Information overload'];
const solutions = ['Educational Content Strategy', 'WhatsApp Automation', 'Lead Scoring Systems'];
...
const servicesAndSolutions: ServiceMediaItem[] = [
  {
    title: 'Course Discovery Campaigns',
    description: 'Interest-based paid campaigns that attract high-fit student leads for each course vertical.',
    mediaType: 'image',
    mediaSrc: 'https://picsum.photos/seed/edu-service-1/960/640',
    mediaAlt: 'Education campaign dashboard',
  },
  {
    title: 'Admission Journey Automation',
    description: 'Automated counseling reminders, brochure sharing, and counselor assignment through CRM.',
    mediaType: 'image',
    mediaSrc: 'https://picsum.photos/seed/edu-service-2/960/640',
    mediaAlt: 'Student admission automation flow',
  },
  {
    title: 'Webinar to Enrollment Funnel',
    description: 'Video-led webinar funnels that nurture prospects and improve enrollment conversions.',
    mediaType: 'video',
    mediaSrc: 'https://www.w3schools.com/html/mov_bbb.mp4',
    mediaAlt: 'Webinar enrollment funnel walkthrough',
  },
];
    ...
    <div className="pt-32 pb-20">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
          <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}>
            ...
            <p className="text-xl text-body mb-10 leading-relaxed">
              Increase student enrollments with targeted lead generation and automated admission pipelines. We
              understand the unique challenges of the Education sector and have built proven systems to overcome them.
            </p>
        ...
        <div className="bg-primary rounded-[40px] p-12 text-center text-white">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to scale your Education business?</h2>
